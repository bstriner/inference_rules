...
def main():
    ...
    output_path = 'output/FB15K/merged_walks_valid'
    ...
    valid = data['valid']
    test = data['test']
    valid_path = '../experiments/output/FB15K/processed/valid.pickle'
    depth = 2
    pos_walks, neg_walks, walk_idx = merge_walks(valid_path, 1, depth)
